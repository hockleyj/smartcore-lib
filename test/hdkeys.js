...
var Networks = smartcore.Networks;
var HDPrivateKey = smartcore.HDPrivateKey;
var HDPublicKey = smartcore.HDPublicKey;
...
describe('BIP32 compliance', function() {
  ...
  describe('edge cases', function() {
    ...
    it('will handle edge case that derived private key is invalid', function() {
      ...
      var unstubbed = smartcore.crypto.BN.prototype.toBuffer;
      var count = 0;
      var stub = sandbox.stub(smartcore.crypto.BN.prototype, 'toBuffer', function(args) {
      ...
      sandbox.spy(smartcore.PrivateKey, 'isValid');
      var key = HDPrivateKey.fromObject({
        network: 'testnet',
        depth: 0,
        parentFingerPrint: 0,
      ...
      smartcore.PrivateKey.isValid.callCount.should.equal(2);
    });
    it('will handle edge case that a derive public key is invalid', function() {
      ...
      var unstubbed = smartcore.PublicKey.fromPoint;
      smartcore.PublicKey.fromPoint = function() {
        smartcore.PublicKey.fromPoint = unstubbed;
